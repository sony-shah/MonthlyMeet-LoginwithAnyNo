        ...
        <div className='right-container'>
          ...
          {userDatanew && userDatanew.length < 1  ?
            ...
            :<ul className='card-data'>
              {userDatanew && userDatanew.filter(badgescheck => badgescheck.isChecked === true).map((badges, key = i) => {
                  ...
                  <>
                    ...
                    <li>
                      <div className='p-cardBox'>
                        <div className='cardImg' onClick={handlebadgespopup}>
                          <img src={badges.badgesimgurls}  alt="badges_img" />
                        </div>

                        <div className='cardContent'>
                          <h3>{badges.badgesname}</h3>
                    ...
                    {isBadgesOpen && <BadgesPopup
                      content={<>
                        <div className='badgespopup-view' style={{ backgroundColor: badges.badgesbgcolor }}>
                          <img src={badges.badgeseventUrls}  />
                          <h2>Congratulations</h2>
                          <h1>{username}</h1>
                          <p className='honoured-name'>You are honoured with the</p>
                          <p className='eventname'>{badges.badgesname}</p>
