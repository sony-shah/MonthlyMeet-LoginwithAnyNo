        ...
        <>
            ...
            <section className="c-background">
                ...
                <div className='signinContainer'>
                    ...
                    {mobilenumerror ? <p>enter your 10 digit number</p> : null}
                    ...
                    </div> : null} {otpvaliderror ? <p>enter valid otp</p> : null}

                    {verifyName ? <div className='loginInput'>
                        <ul className='username-input'>
                            <li>
                                <div>
                                    <input type="text"
                                        name="username"
                            ...
                            <li>
                                <button type="submit" disabled={verifynumber}  onClick={(e) => SubmitData(e)} >{verifynumber ? "Redirecting Home..." : "LOGIN"}</button>

                            </li>

                        </ul>

                    </div> : null} {nameerror ? <p className='name-error'>enter your name</p> : null}
