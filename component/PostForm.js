...
const fivecheckdata = [
    { name: "SuperNova" },
    { name: "Introduction to Fairness" },
    { name: "New Initiative : Free Space" },
    { name: "Introduction of Nucleus Team" },
    { name: "Know your Listed Partners" },
    { name: "None of Above" },
                        ...
                        error?<div className="error"><p>required</p></div>:null
                            ...
                            <div className="form-row">
                               ...
                               <div className="form-row radio-buttons">
                                <h2>1. Does the meeting day of 2nd Saturday of every month work for you? </h2>
                            ...
                            {/* 2nd question */}
                            <div className="form-row radio-buttons">
                                <h2>2. Does the meeting time 4pm-6pm work for you?</h2>
                            ...
                            {/* 3rd question */}
                            <div className="form-row radio-buttons">
                                <h2>3. Did you find the content related to "Fairness" relevant?</h2>
                                <ul>
                            ...
                            {/* 4th question */}
                            <div className="form-row radio-buttons">
                                <h2>4. Will you join the "Freedom to Fairness" session scheduled on Saturday May 28th 2022?</h2>
                                <ul>
                            ...
                            <div className="form-row radio-buttons">
                                <h2>5. Which of the following sections of the meeting you found interesting?( choose one or more options)</h2>
                                <ul>
                            ...
                            {/* 6th question */}
                            <div className="form-row radio-buttons">
                                <h2>6. Will you like to volunteer to be part of the monthly meeting execution team?</h2>
                                <ul>
                                    ...
                                    <li>
                                        <label htmlFor="6B">
                                            <input
                                                id="6B"
                                                value="Not Now, may be later"
                                                name="questionSix"
                                                type="radio"
                                                onChange={questionSix}
                                                checked={sixcheck == 'Not Now, may be later'} />
                                            <div className='custom_radio'></div>
                                            Not Now, may be later</label>
                                    </li>
